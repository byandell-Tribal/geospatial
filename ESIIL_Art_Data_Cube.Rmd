...
```{r}
params$yeartwo <- params$yearone + 1
params
```
...
```{r}
years_start  <- paste0(params$yearone, "-01-01")
years_end    <- paste0(params$yeartwo, "-12-31")
months_start <- paste0(c(params$yearone, params$yeartwo), "-05-01")
months_end   <- paste0(c(params$yearone, params$yeartwo), "-06-30")
days_start <- paste0(params$yeartwo, "-05-15")
days_end   <- paste0(params$yeartwo, "-05-16")
```
