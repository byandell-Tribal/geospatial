...
```{r, cache=TRUE, warning=FALSE, message=FALSE}
layer1 <- denver_redlining
layer2 <- amenity$food_processed
processed_food_match <- process_and_plot_sf_layers(
  layer1, layer2, "processed_food_match.png")
...
create_wordclouds_by_grade(
  ...
  output_file = "processed_food_word_cloud_per_grade.png",
...
```{r, cache=TRUE, warning=FALSE, message=FALSE}
layer1 <- denver_redlining
layer2 <- amenity$natural_habitats
natural_habitats_match <- process_and_plot_sf_layers(
  layer1, layer2, "natural_habitats_match.png")
...
natural_habitats_cloud <- create_wordclouds_by_grade(
  ...
  output_file = "natural_habitats_word_cloud_per_grade.png",
...
```{r, cache=TRUE, warning=FALSE, message=FALSE}
processing_time <- process_satellite_data(
...
crime_cloud <- create_wordclouds_by_grade(
  Crime$layer,
  output_file = "Crime_word_cloud_per_grade.png",
...
Denver_police_shootings_cloud <- create_wordclouds_by_grade(
  ...
  output_file = "police_shootings_word_cloud_per_grade.png",
